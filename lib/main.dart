...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> _services = [
    ['Contacts', Iconsax.export_1, Colors.blue],
  ...
  List<dynamic> _transactions = [
    ...
    ['Cash from ATM', 'https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/2x/external-atm-banking-and-finance-kiranshastry-lineal-color-kiranshastry.png', '5:50pm', '\$200.00'],
    ['Netflix', 'https://img.icons8.com/color-glass/2x/netflix.png', '2:22pm', '\$13.99'],
    ['PayTm', 'https://download.logo.wine/logo/Paytm/Paytm-Logo.wine.png', '2:22pm', '\$13.99'],
  ['GooglePay', 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Google_Pay_Logo.svg/2560px-Google_Pay_Logo.svg.png', '6:25pm', '\$4.99'],
  ];
            ...
            child: Column(
              ...
              children: [
                Container(
                    ...
                    child: Image.asset('assets/images/Nirmal.jpg')
                ),
                SizedBox(height: 10,),
                Padding(
                  padding: EdgeInsets.only(left: 30.0),
                  child: Text("Nanera Nirmal",
